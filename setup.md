...
**NOTE**: I am using the vim editor as text editor here. If you are unfamiliar with vim check out the vimbook "Basic editing" chapter. You can download it by clicking the PDF format button on the [vimdoc page](http://vimdoc.sourceforge.net/). In addition check out vimadventures. This game teaches you how to use vim [effectively](https://vim-adventures.com/)

Back to oh-my-zsh. Add plugins to zsh config file. 
```
vim ~/.zshrc
```
